"""
Django settings for fresh_air project.
...
SECRET_KEY = '(!9+7o+*lpmg_1$xk!2d9#ju4+8n=1or-ac=5+%%9!cg6(%xb%'
...
WSGI_APPLICATION = 'fresh_air.wsgi.application'
